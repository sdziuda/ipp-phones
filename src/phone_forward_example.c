...
int main() {
  ...
  phfwdDelete(pf);
    ...
    phfwdAdd(pf2, "123", "456");
    phfwdAdd(pf2, "123456", "7777");
    phfwdAdd(pf2, "123457", "8888");
    pnum2 = phfwdGet(pf2, "123");
    assert(strcmp(phnumGet(pnum2, 0), "456") == 0);
    phnumDelete(pnum2);

    pnum2 = phfwdGet(pf2, "1234");
    assert(strcmp(phnumGet(pnum2, 0), "4564") == 0);
    phnumDelete(pnum2);

    pnum2 = phfwdGet(pf2, "12345");
    assert(strcmp(phnumGet(pnum2, 0), "45645") == 0);
    phnumDelete(pnum2);

    pnum2 = phfwdGet(pf2, "123456");
    assert(strcmp(phnumGet(pnum2, 0), "7777") == 0);
    phnumDelete(pnum2);
    pnum2 = phfwdGet(pf2, "123457");
    assert(strcmp(phnumGet(pnum2, 0), "8888") == 0);
    phnumDelete(pnum2);

    phfwdRemove(pf2, "1234");
    ...
    pnum2 = phfwdGet(pf2, "123456");
    assert(strcmp(phnumGet(pnum2, 0), "456456") == 0);
    phnumDelete(pnum2);

    pnum2 = phfwdGet(pf2, "123457");
    assert(strcmp(phnumGet(pnum2, 0), "456457") == 0);
    phnumDelete(pnum2);
